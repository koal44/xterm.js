...
export interface IBufferLine {
  ...
  deleteNullFill(pos: number, n: number, fillAttr: IAttributeData): void;
  // replaceCells(start: number, end: number, fill: ICellData, respectProtect?: boolean): void;
  replaceNullFill(start: number, end: number, fillAttr: IAttributeData, respectProtect?: boolean): void;
  // resize(cols: number, fill: ICellData): boolean;
  resizeNullFill(cols: number, fillAttr: IAttributeData): boolean;
  cleanupMemory(): number;
  // fill(fillCellData: ICellData, respectProtect?: boolean): void;
  fillToNull(fillAttr: IAttributeData, respectProtect?: boolean): void;
  fillToAscii(char: string, fillAttr: IAttributeData, respectProtect?: boolean): void;
