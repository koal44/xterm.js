...
describe('BufferReflow', () => {
  describe('reflowSmallerGetNewLineLengths', () => {
    it('should return correct line lengths for a small line with wide characters', () => {
      ...
      line.setCell(0, CellData.fromCharData([0, '汉', 2]));
      line.setCell(1, CellData.fromCharData([0, '', 0]));
      line.setCell(2, CellData.fromCharData([0, '语', 2]));
      line.setCell(3, CellData.fromCharData([0, '', 0]));
    ...
    it('should return correct line lengths for a large line with wide characters', () => {
      ...
      for (let i = 0; i < 12; i += 4) {
        line.setCell(i, CellData.fromCharData([0, '汉', 2]));
        line.setCell(i + 2, CellData.fromCharData([0, '语', 2]));
      }
      for (let i = 1; i < 12; i += 2) {
        line.setCell(i, CellData.fromCharData([0, '', 0]));
        line.setCell(i, CellData.fromCharData([0, '', 0]));
      }
    ...
    it('should return correct line lengths for a string with wide and single characters', () => {
      ...
      line.setCell(0, CellData.fromCharData([0, 'a', 1]));
      line.setCell(1, CellData.fromCharData([0, '汉', 2]));
      line.setCell(2, CellData.fromCharData([0, '', 0]));
      line.setCell(3, CellData.fromCharData([0, '语', 2]));
      line.setCell(4, CellData.fromCharData([0, '', 0]));
      line.setCell(5, CellData.fromCharData([0, 'b', 1]));
    ...
    it('should return correct line lengths for a wrapped line with wide and single characters', () => {
      ...
      line1.setCell(0, CellData.fromCharData([0, 'a', 1]));
      line1.setCell(1, CellData.fromCharData([0, '汉', 2]));
      line1.setCell(2, CellData.fromCharData([0, '', 0]));
      line1.setCell(3, CellData.fromCharData([0, '语', 2]));
      line1.setCell(4, CellData.fromCharData([0, '', 0]));
      line1.setCell(5, CellData.fromCharData([0, 'b', 1]));
      const line2 = new BufferLine(6, undefined, true);
      line2.setCell(0, CellData.fromCharData([0, 'a', 1]));
      line2.setCell(1, CellData.fromCharData([0, '汉', 2]));
      line2.setCell(2, CellData.fromCharData([0, '', 0]));
      line2.setCell(3, CellData.fromCharData([0, '语', 2]));
      line2.setCell(4, CellData.fromCharData([0, '', 0]));
      line2.setCell(5, CellData.fromCharData([0, 'b', 1]));
    ...
    it('should work on lines ending in null space', () => {
      ...
      line.setCell(2, CellData.fromCharData([0, '语', 2]));
      line.setCell(3, CellData.fromCharData([0, '', 0]));
      line.setCell(4, CellData.fromCharData([0, NULL_CELL_CHAR, NULL_CELL_WIDTH]));
      assert.equal(line.translateToString(true), '汉语');
